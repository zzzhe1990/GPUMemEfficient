...
SPATH=~/Desktop/GPUMemEfficient/SmithWaterman/
cd SPATH
...
SPATH=~/Desktop/GPUMemEfficient/EditDistance/
cd SPATH
nvprof --metrics METRICS --log-file share_nvprof_1080ti_128_32.log ./GPU_Hyperlane_Share 15 15 32 128 1
nvprof --metrics METRICS --log-file share_nvprof_1080ti_256_32.log ./GPU_Hyperlane_Share 15 15 32 256 1
SPATH=~/Desktop/GPUMemEfficient/2D-SOR/nested_loop/
cd SPATH
nvprof --metrics METRICS --log-file share_nvprof_1080ti_128_32.log ./GPU_Hyperlane_Share 15 15 32 128 1
nvprof --metrics METRICS --log-file share_nvprof_1080ti_256_32.log ./GPU_Hyperlane_Share 15 15 32 256 1
SPATH=~/Desktop/GPUMemEfficient/SAT/
cd SPATH
nvprof --metrics METRICS --log-file share_nvprof_1080ti_128_32.log ./GPU_Hyperlane_Share 15 15 32 128 1
nvprof --metrics METRICS --log-file share_nvprof_1080ti_256_32.log ./GPU_Hyperlane_Share 15 15 32 256 1
